...
variable "shutdown_t" {
  type    = string
  default = "30m"
  description = "The default shutdown timeout"
}

variable "cpu" {
  type        = string
  description = "The amount of CPU's to assign this image"
  default = 4
...
source "hyperv-iso" "vm" {
  ...
  shutdown_timeout      = "${var.shutdown_t}"
  skip_export           = true
